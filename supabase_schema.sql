...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  -- 1: Foundation, 2: Specialist, 3: Strategic, 4: Master
...
VALUES (
    1,
    'Digital Identity',
    'ตั้งค่าโปรไฟล์และ Digital Name Card',
    'TOOLSET',
    500
  ),
  (
    1,
    'ABCD Mastery',
    'ซ้อมพูด Mindset ABCD กับ AI Coach',
    'MINDSET',
    300
  ),
  (
    2,
    'TikTok Specialist',
    'สร้างคลิปรีวิวสินค้า และเชื่อม One Link',
    'SKILLSET',
    1000
  );