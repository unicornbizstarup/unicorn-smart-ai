...
function meta$j() {
  return [{
    ...
    name: "description",
    content: "Unicorn Smart AI - สถาบันพัฒนาศักยภาพทางธุรกิจและเทคโนโลยี AI เพื่อก้าวสู่การเป็นนักธุรกิจยุคใหม่"
  }];
}
const links = () => [{
  rel: "preconnect",
...
function createServerSupabase(request, responseHeaders = new Headers()) {
  const cfEnv = (typeof globalThis !== "undefined" ? globalThis.CF_ENV : null) || {};
  const url = cfEnv.VITE_SUPABASE_URL || process.env.VITE_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL || "https://placeholder.supabase.co";
  const anonKey = cfEnv.VITE_SUPABASE_ANON_KEY || process.env.VITE_SUPABASE_ANON_KEY || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || "placeholder-build-key";
...
function createServiceSupabase() {
  const cfEnv = (typeof globalThis !== "undefined" ? globalThis.CF_ENV : null) || {};
  const url = cfEnv.VITE_SUPABASE_URL || process.env.VITE_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL || "https://placeholder.supabase.co";
  const serviceKey = cfEnv.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY || "placeholder-build-key";
      ...
      children: /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: "🌐 เว็บไซต์บริษัท (Unicorn Global Link)"
          })]
        }), /* @__PURE__ */ jsx("div", {
...
function meta$h() {
  return [{
    ...
    name: "description",
    content: "เข้าสู่ระบบ Unicorn Smart AI Platform"
  }];
}
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx("div", {
              ...
              children: [/* @__PURE__ */ jsx("h4", {
                ...
                children: "สมัครสมาชิกร่วมธุรกิจกับ ทาง บริษัท ยูนิคอร์น โกลบอล ลิ้งค์ จำกัด"
              })]
            })]
          }), /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx("div", {
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                ...
                children: [/* @__PURE__ */ jsx("h4", {
                  className: "text-sm font-bold text-text-primary",
                  children: "เข้าใช้งานระบบสนับสนุนสมาชิก"
                }), /* @__PURE__ */ jsxs("p", {
                  className: "text-xs text-text-secondary leading-relaxed font-semibold",
                  children: ["เข้าใช้งานผ่าน ระบบสนับสนุนสมาชิก ", /* @__PURE__ */ jsx("a", {
                    href: "https://www.uglplatform.com/Account/Login",
                    target: "_blank",
                    rel: "noopener noreferrer",
                    className: "text-brand-gold hover:underline font-bold break-all",
                    children: "https://www.uglplatform.com/Account/Login"
                  })]
                })]
              }), /* @__PURE__ */ jsx("div", {
                children: /* @__PURE__ */ jsxs("a", {
                  ...
                  children: [/* @__PURE__ */ jsx("span", {
                    children: "ไปยังระบบสนับสนุนสมาชิก UGL"
            ...
            children: [/* @__PURE__ */ jsx("div", {
              ...
              children: [/* @__PURE__ */ jsx("h4", {
                ...
                className: "text-xs text-text-secondary leading-relaxed font-semibold",
                children: "หรือ ติดต่อผู้แนะนำธุรกิจยูนิคอร์นนี้ให้กับท่าน"
              })]
            })]
          })]
        }), /* @__PURE__ */ jsxs("div", {
...
function MemberLayout({ children, profile: profile2, title, subtitle, actions }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-[var(--bg-page)] flex items-center justify-center p-0 sm:p-6 font-body", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[430px] min-h-screen sm:min-h-[850px] sm:max-h-[900px] bg-[var(--bg-page)] shadow-2xl relative flex flex-col pb-20 overflow-x-hidden sm:rounded-[2.5rem] sm:border-[6px] sm:border-[var(--border-strong)]", children: [
    ...
    /* @__PURE__ */ jsxs("nav", { className: "bottom-nav", children: [
      ...
      /* @__PURE__ */ jsx(
        Link,
        {
          ...
          children: /* @__PURE__ */ jsx(Crown, { className: "w-6 h-6 animate-pulse" })
        }
      ),
      /* @__PURE__ */ jsxs(
        Link,
...
function meta$f() {
  return [{
    ...
    name: "description",
    content: "แผงควบคุมระบบสมาชิกและการเรียนรู้ Unicorn Smart AI"
  }];
}
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx("div", {
              className: "w-8 h-8 rounded-lg bg-brand-gold-light/40 flex items-center justify-center text-brand-gold shadow-sm group-hover:scale-110 transition-transform",
        ...
        children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: missions2 && missions2.length > 0 ? missions2.map((um) => {
              ...
              return /* @__PURE__ */ jsxs("div", {
                ...
                children: [/* @__PURE__ */ jsxs("div", {
                  className: "flex items-center gap-3",
                  children: [/* @__PURE__ */ jsx("div", {
                    className: "w-10 h-10 rounded-xl flex items-center justify-center shadow-sm bg-white border border-border-default shrink-0",
                    children: ((_a = um.mission) == null ? void 0 : _a.category) === "MINDSET" ? /* @__PURE__ */ jsx(Lightbulb, {
                      size: 20,
                      className: "text-brand-gold"
                    }) : ((_b = um.mission) == null ? void 0 : _b.category) === "SKILLSET" ? /* @__PURE__ */ jsx(Target, {
                      size: 20,
                      className: "text-brand-gold"
                    }) : /* @__PURE__ */ jsx(Wrench, {
                      size: 20,
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsxs(Link, {
              ...
              children: [/* @__PURE__ */ jsx("div", {
                className: "w-10 h-10 rounded-xl bg-white border border-border-default flex items-center justify-center text-brand-gold shadow-sm mb-3 group-hover:scale-110 transition-transform",
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            children: [{
              ...
              children: [/* @__PURE__ */ jsx("div", {
                className: "w-10 h-10 rounded-xl bg-white border border-border-default flex items-center justify-center text-brand-gold shadow-sm mb-1.5 group-hover:scale-110 transition-transform",
...
const profile = UNSAFE_withComponentProps(function ProfilePage() {
  ...
  const [profile2, setProfile] = useState({
    ...
    line_oa: (loadedProfile == null ? void 0 : loadedProfile.line_oa_url) || "",
    youtube_url: (loadedProfile == null ? void 0 : loadedProfile.youtube_url) || "",
    referral_slug: (loadedProfile == null ? void 0 : loadedProfile.username) || "",
    avatar_url: (loadedProfile == null ? void 0 : loadedProfile.avatar_url) || "",
    photo_urls: (loadedProfile == null ? void 0 : loadedProfile.photo_urls) || [],
    photo_captions: (loadedProfile == null ? void 0 : loadedProfile.photo_captions) || []
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const {
        ...
        line_oa_url: profile2.line_oa,
        youtube_url: profile2.youtube_url,
        username: cleanSlug,
        photo_urls: profile2.photo_urls,
        photo_captions: profile2.photo_captions
      }).eq("id", user.id);
      if (updateError) {
  ...
  return /* @__PURE__ */ jsx(MemberLayout, {
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          className: "w-full bg-gradient-to-b from-[#1a1209] to-[#2d2112] border border-border-strong rounded-2xl p-6 flex flex-col items-center text-center space-y-6 shadow-md",
          children: [/* @__PURE__ */ jsx("h3", {
            className: "text-xs font-black !text-white/45 uppercase tracking-widest block w-full text-left",
          ...
          children: [error && /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              className: "border-t border-border-default pt-6 space-y-4",
              children: [/* @__PURE__ */ jsxs("div", {
                className: "space-y-1",
                children: [/* @__PURE__ */ jsx("h3", {
                  className: "text-sm font-display text-brand-gold font-bold",
                  children: "ภาพกิจกรรมและแบรนดิ้งบุคคล (3-5 ภาพ)"
                }), /* @__PURE__ */ jsx("p", {
                  className: "text-xs text-text-secondary",
                  children: "อัปโหลดรูปภาพที่แสดงถึงความเชี่ยวชาญ ภาพกิจกรรม หรือผลลัพธ์ธุรกิจของคุณเพื่อแสดงบนหน้า Sale Page (แนะนำอัปโหลดอย่างน้อย 3 ภาพ)"
                })]
              }), /* @__PURE__ */ jsx("div", {
                className: "grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4",
                children: [0, 1, 2, 3, 4].map((idx) => {
                  var _a, _b;
                  const url = (_a = profile2.photo_urls) == null ? void 0 : _a[idx];
                  const caption = ((_b = profile2.photo_captions) == null ? void 0 : _b[idx]) || "";
                  return /* @__PURE__ */ jsxs("div", {
                    className: "flex flex-col gap-2 p-3 bg-bg-page border border-border-default rounded-xl hover:border-brand-gold-muted transition-all relative",
                    children: [/* @__PURE__ */ jsxs("span", {
                      className: "text-[10px] font-bold text-text-secondary uppercase",
                      children: ["ภาพที่ ", idx + 1]
                    }), /* @__PURE__ */ jsx("div", {
                      className: "w-full aspect-[4/3] rounded-lg overflow-hidden bg-bg-input border border-border-default relative flex items-center justify-center",
                      children: url ? /* @__PURE__ */ jsxs(Fragment, {
                        ...
                        className: "cursor-pointer flex flex-col items-center justify-center w-full h-full text-text-muted hover:text-brand-gold transition-colors",
                        children: [/* @__PURE__ */ jsx(Camera, {
                          size: 20,
                          className: "mb-0.5 opacity-75"
                        }), /* @__PURE__ */ jsx("span", {
...
const MessageContentRenderer = ({
  ...
  const renderCleanText = (txt) => {
    ...
    return /* @__PURE__ */ jsx("div", {
      ...
      children: lines.map((line, lIdx) => {
        ...
        if (!cleanLine) return /* @__PURE__ */ jsx("div", {
          className: "h-2"
        }, lIdx);
        ...
        while ((match = boldRegex.exec(cleanLine)) !== null) {
          ...
          parts.push(/* @__PURE__ */ jsx("strong", {
        ...
        if (isBullet) {
          return /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx("span", {
              className: "w-1.5 h-1.5 rounded-full bg-brand-gold mt-1.5 shrink-0"
            }), /* @__PURE__ */ jsx("span", {
              className: "text-text-primary text-xs md:text-sm font-semibold",
              children: lineContent
            })]
          }, lIdx);
        }
        return /* @__PURE__ */ jsx("p", {
          className: "text-text-primary text-xs md:text-sm min-h-[1em] font-semibold",
          children: lineContent
        }, lIdx);
      })
    });
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [introText && /* @__PURE__ */ jsx("div", {
      className: "text-text-primary leading-relaxed",
      children: renderCleanText(introText)
    }), /* @__PURE__ */ jsxs("div", {
      className: "bg-bg-page border border-brand-gold/25 rounded-2xl overflow-hidden shadow-sm flex flex-col w-full animate-fade-in",
      children: [header && /* @__PURE__ */ jsxs("div", {
        className: "px-4 py-2.5 bg-brand-gold/10 border-b border-brand-gold/15 flex items-center justify-between",
        children: [/* @__PURE__ */ jsx("span", {
          className: "font-bold text-xs md:text-sm text-brand-dark flex items-center gap-1.5",
          children: header
        }), /* @__PURE__ */ jsx("span", {
          className: "text-[8px] font-extrabold text-brand-gold bg-white px-2 py-0.5 rounded-full border border-brand-gold/15 uppercase tracking-widest shrink-0 select-none",
          children: "Flex Message"
        })]
      }), /* @__PURE__ */ jsxs("div", {
        className: "p-4 flex flex-col gap-3.5 bg-white",
        children: [body && /* @__PURE__ */ jsx("div", {
          className: "text-xs md:text-sm text-text-secondary leading-relaxed border-l-2 border-brand-gold/30 pl-3",
          children: renderCleanText(body)
          ...
          return /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              className: "flex items-center justify-between border-b border-brand-gold-muted/10 pb-1.5",
              children: [/* @__PURE__ */ jsxs("span", {
                className: "font-bold text-[10px] md:text-[11px] text-brand-gold flex items-center gap-1 select-none",
                ...
                children: isCopied ? "คัดลอกแล้ว ✓" : "คัดลอกบทพูด 📋"
              })]
            }), /* @__PURE__ */ jsxs("p", {
              className: "text-xs md:text-sm text-brand-dark italic whitespace-pre-wrap font-semibold leading-relaxed",
          ...
          return /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsxs("span", {
                className: "font-bold text-[10px] md:text-[11px] text-brand-gold-muted flex items-center gap-1 select-none",
                ...
                children: isCopied ? "คัดลอกแล้ว ✓" : "คัดลอก Prompt 📋"
              })]
            }), /* @__PURE__ */ jsx("pre", {
              className: "text-[11px] md:text-xs font-mono whitespace-pre-wrap text-brand-gold-light/95 leading-relaxed overflow-x-auto",
              children: prompt.content
            })]
          }, pIdx);
        }), mission && /* @__PURE__ */ jsxs("div", {
          className: "bg-emerald-50/40 border border-emerald-200/40 rounded-xl p-3.5 flex flex-col gap-2",
          children: [/* @__PURE__ */ jsx("span", {
            className: "font-bold text-[10px] md:text-[11px] text-emerald-800 flex items-center gap-1 select-none",
            children: "🏆 ภารกิจปฏิบัติการ (Action Plan)"
          }), /* @__PURE__ */ jsx("div", {
            className: "text-emerald-950",
            children: renderCleanText(mission)
          })]
        })]
      })]
    })]
  ...
  return /* @__PURE__ */ jsx(MemberLayout, {
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("header", {
        className: "px-4 py-3 flex flex-col gap-3 shrink-0 border-b border-border-default bg-white relative z-10 w-full",
        children: [/* @__PURE__ */ jsxs("div", {
          className: "flex items-center justify-between w-full",
          children: [/* @__PURE__ */ jsxs(Link, {
            to: "/dashboard",
            className: "flex items-center gap-1 text-text-secondary hover:text-brand-gold transition-colors font-semibold text-xs py-1",
            children: [/* @__PURE__ */ jsx(ChevronLeft, {
              size: 16
            }), /* @__PURE__ */ jsx("span", {
          ...
          children: focusOptions.map((f) => /* @__PURE__ */ jsxs("button", {
            ...
            className: `flex-1 flex items-center justify-center gap-1 px-2 py-1.5 rounded-lg text-[11px] font-bold transition-all whitespace-nowrap ${focusArea === f.id ? "bg-brand-gold text-white shadow-sm" : "text-text-secondary hover:text-text-primary hover:bg-white/50"}`,
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [messages.map((m, idx) => /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsxs("div", {
              className: `flex gap-3 w-full ${m.role === "user" ? "justify-end max-w-[85%] flex-row-reverse" : "justify-start max-w-full md:max-w-[85%] flex-row flex-1"}`,
              children: [/* @__PURE__ */ jsx("div", {
                className: `w-9 h-9 rounded-xl flex items-center justify-center shrink-0 shadow-sm border ${m.role === "user" ? "bg-brand-gold border-brand-gold text-white" : "bg-brand-gold-light/35 border-brand-gold-muted/30 text-brand-gold"}`,
                ...
                className: `rounded-2xl p-4 text-xs md:text-sm leading-relaxed font-medium shadow-sm border w-full ${m.role === "user" ? "bg-brand-gold text-white border-brand-gold rounded-tr-none" : "bg-white text-text-primary border-border-default rounded-tl-none flex-1"}`,
                children: m.role === "user" ? /* @__PURE__ */ jsx("p", {
                  className: "whitespace-pre-wrap",
                  children: m.content
                }) : /* @__PURE__ */ jsx(MessageContentRenderer, {
                  content: m.content,
                  idx,
                  copiedTextId,
            ...
            children: [/* @__PURE__ */ jsx("div", {
              className: "w-9 h-9 rounded-xl bg-brand-gold-light/35 border border-brand-gold-muted/30 flex items-center justify-center text-brand-gold shadow-sm",
              children: /* @__PURE__ */ jsx(Crown, {
                size: 16,
                className: "animate-pulse"
              })
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          className: "text-2xl sm:text-3xl font-display font-bold leading-tight text-text-primary",
        ...
        className: "p-5 bg-gradient-to-br from-brand-dark to-[#2c1d0c] rounded-2xl flex flex-col items-center gap-4 text-white shadow-md text-center",
        children: [/* @__PURE__ */ jsxs("div", {
...
const referral_$slug = UNSAFE_withComponentProps(function ReferralPage() {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "min-h-screen bg-[#f7f4ef] text-text-primary font-body text-sm leading-relaxed pb-16 selection:bg-brand-gold/30",
    children: [/* @__PURE__ */ jsx("div", {
      className: "h-1.5 bg-gradient-to-r from-[#c0281e] via-[#e8621a] to-[#f5a623]"
    }), /* @__PURE__ */ jsxs("nav", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("div", {
          ...
          style: {
            background: "linear-gradient(135deg, #c0281e, #f5a623)"
          },
          children: "U"
        }), /* @__PURE__ */ jsxs("div", {
          children: [/* @__PURE__ */ jsx("div", {
      ...
      className: "max-w-4xl mx-auto px-4 pt-12 pb-8 text-center relative overflow-hidden",
      children: [/* @__PURE__ */ jsx("div", {
        className: "absolute inset-0 pointer-events-none bg-gradient-to-b from-brand-gold-light/15 via-[#f7f4ef]/50 to-transparent"
      }), /* @__PURE__ */ jsx("div", {
        className: "absolute top-10 left-10 w-24 h-24 bg-[#c0281e]/5 rounded-full blur-2xl pointer-events-none"
      }), /* @__PURE__ */ jsx("div", {
        className: "absolute top-20 right-10 w-32 h-32 bg-[#f5a623]/5 rounded-full blur-3xl pointer-events-none"
      }), /* @__PURE__ */ jsxs("div", {
        className: "relative inline-block mb-5 z-10 select-none",
        children: [/* @__PURE__ */ jsx("div", {
          className: "w-24 h-24 rounded-3xl overflow-hidden border-2 border-brand-gold mx-auto shadow-lg hover:rotate-1 transition-transform",
          children: profile2.avatar_url ? /* @__PURE__ */ jsx("img", {
            src: profile2.avatar_url,
            alt: displayName,
            className: "object-cover w-full h-full"
          }) : /* @__PURE__ */ jsx("div", {
            className: "w-full h-full flex items-center justify-center text-3xl font-black text-white bg-brand-gold",
            children: initials
          })
        }), profile2.is_verified && /* @__PURE__ */ jsx("div", {
          className: "absolute -bottom-1.5 -right-1.5 w-6 h-6 rounded-full bg-brand-gold border-2 border-white flex items-center justify-center text-[10px] font-black text-white shadow-md",
          children: "✓"
        })]
      }), /* @__PURE__ */ jsx("div", {
        children: /* @__PURE__ */ jsxs("div", {
          className: "inline-flex items-center gap-1.5 bg-brand-gold-light/50 border border-brand-gold-muted/20 rounded-full px-4 py-1 text-[10px] font-black text-brand-gold uppercase tracking-wider mb-4 z-10 relative",
          children: ["⭐ UBC ", level, " · ", levelLabels[level]]
        })
      }), /* @__PURE__ */ jsx("h1", {
        className: "text-3xl font-display font-bold text-text-primary leading-tight mb-2.5 relative z-10 tracking-tight",
        children: displayName
      }), profile2.specialization && /* @__PURE__ */ jsxs("p", {
        className: "text-xs text-brand-gold font-black tracking-widest mb-5 relative z-10 uppercase",
        children: ["✨ ", profile2.specialization]
      }), profile2.quote && /* @__PURE__ */ jsxs("div", {
        className: "text-sm md:text-base text-text-secondary italic leading-relaxed max-w-lg mx-auto px-6 py-4 bg-white/40 border border-border-default/50 rounded-2xl shadow-sm relative z-10",
        children: [/* @__PURE__ */ jsx("span", {
          className: "text-brand-gold text-3xl leading-none align-[-0.2em] mr-1 font-display",
          children: "“"
        }), profile2.quote, /* @__PURE__ */ jsx("span", {
          className: "text-brand-gold text-3xl leading-none align-[-0.2em] ml-1 font-display",
          children: "”"
        })]
      })]
    }), profile2.photo_urls && profile2.photo_urls.filter(Boolean).length > 0 && /* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: "ภาพกิจกรรมและการทำงานของที่ปรึกษา"
        }), /* @__PURE__ */ jsx("p", {
          className: "text-xs text-text-muted",
          children: "ความมุ่งมั่นและความเชี่ยวชาญผ่านกิจกรรมจริง (คลิกเพื่อขยายภาพ)"
        })]
      }), /* @__PURE__ */ jsx("div", {
        className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4",
        children: profile2.photo_urls.filter(Boolean).map((url, idx) => {
          var _a2, _b;
          return /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx("img", {
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                className: "text-[9px] font-black text-brand-gold uppercase tracking-widest mb-1",
                children: ["IMAGE ", idx + 1]
              }), /* @__PURE__ */ jsx("p", {
                className: "text-xs font-bold text-white line-clamp-2 leading-relaxed",
                children: ((_b = profile2.photo_captions) == null ? void 0 : _b[idx]) || "ภาพกิจกรรมและการแบ่งปันโอกาสทางธุรกิจ"
              })]
            })]
          }, idx);
        })
      ...
      children: (bioText || tags.length > 0) && /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          className: "px-6 py-4 border-b border-border-default bg-bg-input flex items-center gap-2",
          children: [/* @__PURE__ */ jsx("span", {
          ...
          children: [/* @__PURE__ */ jsx("div", {
            ...
            children: displayName
          }), profile2.specialization && /* @__PURE__ */ jsxs("div", {
            className: "flex items-center gap-2 text-xs font-black text-brand-gold uppercase tracking-wide",
            children: [/* @__PURE__ */ jsx("span", {
              className: "inline-block w-4 h-0.5 rounded bg-brand-gold shrink-0"
            }), profile2.specialization]
          }), bioText && /* @__PURE__ */ jsx("p", {
            className: "text-xs sm:text-sm text-text-secondary leading-relaxed whitespace-pre-wrap font-medium",
            children: bioText
          }), tags.length > 0 && /* @__PURE__ */ jsx("div", {
            className: "flex flex-wrap gap-1.5 pt-4 border-t border-border-muted",
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          className: "text-xs text-text-muted",
          children: "ขับเคลื่อนธุรกิจด้วยระบบอัตโนมัติระดับโลก"
        })]
      }), /* @__PURE__ */ jsx("div", {
        ...
        children: [{
          dot: "#b8924a",
          label: "AI Coach",
          desc: "น้องยูนิช่วยวางแผนและโค้ชชิ่งธุรกิจส่วนตัว 24 ชม.",
          bg: "from-amber-500/10 to-transparent border-amber-500/20"
        }, {
          dot: "#e8621a",
          label: "Wealth DNA",
          desc: "ถอดรหัสศักยภาพและธาตุความมั่งคั่งตามโฉลก",
          bg: "from-orange-500/10 to-transparent border-orange-500/20"
        }, {
          dot: "#f5a623",
          label: "Missions Board",
          desc: "ระบบพัฒนาทักษะธุรกิจเป็นขั้นเป็นตอนและเข้าใจง่าย",
          bg: "from-yellow-500/10 to-transparent border-yellow-500/20"
        }, {
          dot: "#10b981",
          label: "5 เริ่มต้น 8 รายได้",
          desc: "แผนการรับรายได้ที่รวดเร็วและคุ้มค่าที่สุดในอุตสาหกรรม",
          bg: "from-emerald-500/10 to-transparent border-emerald-500/20"
        }, {
          dot: "#8b5cf6",
          label: "Digital Name Card",
          desc: "นามบัตรดิจิทัลสร้าง Personal Brand ดูเป็นที่ปรึกษามืออาชีพ",
          bg: "from-violet-500/10 to-transparent border-violet-500/20"
        }].map((f) => /* @__PURE__ */ jsxs("div", {
          className: `bg-gradient-to-br ${f.bg} bg-white border rounded-2xl p-5 shadow-sm hover:shadow-md transition-all hover:scale-[1.02] duration-300`,
          children: [/* @__PURE__ */ jsxs("div", {
            ...
            className: "text-[11px] text-text-secondary leading-relaxed font-semibold",
            children: f.desc
          })]
        }, f.label))
      })]
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          className: "text-xs text-text-muted",
          children: "ครอบคลุมทุกความต้องการ มั่นใจด้วยมาตรฐานระดับสากล"
        })]
      }), /* @__PURE__ */ jsx("div", {
        className: "grid grid-cols-1 sm:grid-cols-2 gap-4",
        children: (categories && categories.length > 0 ? categories : [{
          name: "U-LIFE BOOST",
          display_name_th: "ผลิตภัณฑ์เสริมอาหาร (Health Care)",
          banner_url: null,
          slug: "u-life-boost",
          description: "นวัตกรรมเพื่อสุขภาพ ฟื้นฟูร่างกายและเสริมสร้างภูมิคุ้มกันระดับเซลล์"
        }, {
          name: "U-SKIN",
          display_name_th: "ผลิตภัณฑ์สกินแคร์ (Skin Care)",
          banner_url: null,
          slug: "u-skin",
          description: "นวัตกรรมบำรุงผิวพรรณอย่างล้ำลึก ย้อนวัยและคืนความอ่อนเยาว์อย่างธรรมชาติ"
        }, {
          name: "U-CARE",
          display_name_th: "ผลิตภัณฑ์ของใช้ส่วนตัว (Personal Care)",
          banner_url: null,
          slug: "u-care",
          description: "ผลิตภัณฑ์ทำความสะอาดและดูแลสุขอนามัยในชีวิตประจำวันเพื่อครอบครัว"
        }, {
          name: "U-PLANT",
          display_name_th: "ผลิตภัณฑ์การเกษตร (Agriculture)",
          banner_url: null,
          slug: "u-plant",
          description: "นวัตกรรมเพื่อเกษตรกรรมออร์แกนิก ปลอดภัยและเพิ่มผลผลิตยั่งยืน"
        }]).map((cat) => {
          var _a2;
          const config = {
            "u-life-boost": {
          ...
          const key = cat.slug || ((_a2 = cat.name) == null ? void 0 : _a2.toLowerCase().replace(/\s+/g, "-")) || "";
          const theme = config[key] || {
            icon: cat.icon_url || "📦",
            bg: "bg-slate-50 text-slate-700 border-slate-100"
          };
          return /* @__PURE__ */ jsxs("div", {
            className: "bg-white border border-border-default rounded-2xl p-5 flex items-start gap-4 shadow-sm hover:shadow-md transition-all hover:border-brand-gold-muted group",
            children: [/* @__PURE__ */ jsx("div", {
              className: `w-12 h-12 rounded-2xl flex items-center justify-center text-2xl shrink-0 border ${theme.bg} group-hover:scale-105 transition-transform duration-300`,
              children: theme.icon
            }), /* @__PURE__ */ jsxs("div", {
              children: [/* @__PURE__ */ jsx("div", {
                className: "text-sm font-black text-text-primary mb-1 group-hover:text-brand-gold transition-colors",
                children: cat.display_name_th || cat.name
              }), /* @__PURE__ */ jsx("p", {
                className: "text-xs text-text-secondary leading-relaxed",
                children: cat.description || `กลุ่มผลิตภัณฑ์คุณภาพสูงและมีมาตรฐานระดับสากลภายใต้แบรนด์ ${cat.name}`
              })]
            })]
          }, cat.id || cat.name);
        })
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          className: "text-xs text-text-muted",
          children: "เหตุผลที่ทุกคนเลือกเริ่มต้นและเติบโตกับแพลตฟอร์มของเรา"
        })]
      }), /* @__PURE__ */ jsx("div", {
        className: "grid grid-cols-1 sm:grid-cols-2 gap-4",
        children: [{
          ...
          className: "bg-white border border-border-default rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-brand-gold-muted transition-all",
          children: [/* @__PURE__ */ jsxs("div", {
      ...
      children: /* @__PURE__ */ jsxs("div", {
        className: "rounded-3xl p-8 md:p-12 text-center bg-gradient-to-br from-[#1a1209] to-[#2d2112] text-white border border-brand-gold/30 shadow-2xl relative overflow-hidden",
        children: [/* @__PURE__ */ jsx("div", {
          className: "absolute top-0 right-0 w-48 h-48 bg-brand-gold/10 rounded-full blur-3xl pointer-events-none"
        }), /* @__PURE__ */ jsx("h2", {
          className: "text-xl md:text-2xl font-display text-white mb-2 font-bold tracking-tight",
          children: "พร้อมร่วมสร้างความสำเร็จแล้วหรือยัง?"
        }), /* @__PURE__ */ jsx("p", {
          className: "text-xs text-white/60 mb-8 leading-relaxed max-w-md mx-auto font-medium",
          ...
          children: "🚀 สมัครเป็นที่ปรึกษาร่วมธุรกิจ"
        }), /* @__PURE__ */ jsxs("p", {
          className: "text-[10px] text-white/40 flex items-center justify-center gap-1.5 mb-6 font-semibold",
          children: [/* @__PURE__ */ jsx("span", {
            className: "text-emerald-500",
            children: "✓"
          }), " สมัครพาร์ทเนอร์ฟรี — ไม่มีค่าใช้จ่ายรายเดือนหรือแรกเข้า"]
        }), (profile2.line_oa_url || profile2.line_id) && /* @__PURE__ */ jsx("div", {
          className: "max-w-md mx-auto border-t border-white/10 pt-6",
          children: /* @__PURE__ */ jsxs("a", {
            href: profile2.line_oa_url ? profile2.line_oa_url.trim() : `https://line.me/ti/p/~${profile2.line_id.trim()}`,
            target: "_blank",
            rel: "noopener noreferrer",
            ...
            children: [/* @__PURE__ */ jsx("span", {
              ...
              children: [/* @__PURE__ */ jsxs("p", {
                ...
                children: ["ทัก LINE ส่วนตัวกับ ", displayName]
              }), /* @__PURE__ */ jsx("p", {
                className: "text-[10px] text-white/80 font-medium",
                children: "ปรึกษาโอกาสธุรกิจและเครื่องมือ AI เพิ่มเติมได้ทันที"
              })]
            })]
          })
        }), (profile2.facebook_url || profile2.youtube_url || profile2.instagram_url) && /* @__PURE__ */ jsxs("div", {
          className: "flex gap-2.5 mt-6 justify-center flex-wrap",
      ...
      children: /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("img", {
          src: activePhoto,
          alt: "Branding enlarged",
          className: "max-w-full max-h-[75vh] object-contain rounded-xl shadow-2xl"
        }), /* @__PURE__ */ jsx("button", {
          className: "absolute -top-10 right-0 text-white font-bold text-xs bg-white/10 hover:bg-white/20 px-4 py-2 rounded-full transition-all",
          children: "ปิด [X]"
        })]
      })
    }), /* @__PURE__ */ jsxs("footer", {
      className: "max-w-4xl mx-auto px-4 mt-12 text-center select-none",
      children: [/* @__PURE__ */ jsxs("p", {
...
async function embedText(text) {
  ...
  if (geminiApiKey && !geminiApiKey.includes("placeholder")) {
    try {
      ...
      if (directRes.ok) {
        const data2 = await directRes.json();
        if ((_a = data2.embedding) == null ? void 0 : _a.values) {
...
async function searchKnowledge(query, matchCount = 5, minScore = 0.65) {
  ...
  if (results.length === 0) {
    try {
      ...
      let queryBuilder = supabase.from("knowledge_chunks").select("id, doc_id, content, metadata");
      ...
      const { data: data2, error } = await queryBuilder.limit(matchCount);
      if (error) {
        console.error("searchKnowledge text fallback error:", error);
      } else if (data2) {
        results = data2.map((row) => ({
          id: row.id,
          doc_id: row.doc_id,
          content: row.content,
          metadata: row.metadata,
          score: 0.8
          // Dummy score for text match
        }));
      }
    } catch (fallbackErr) {
    ...
    if (type === "file") {
      ...
      try {
        ...
        if (fileType.includes("pdf")) {
          const cfEnv = ((_a = context == null ? void 0 : context.cloudflare) == null ? void 0 : _a.env) || {};
          const geminiApiKey = cfEnv.GEMINI_API_KEY || process.env.GEMINI_API_KEY;
          if (!geminiApiKey) {
          ...
          textToIngest = ((_f = (_e = (_d = (_c = (_b = resData.candidates) == null ? void 0 : _b[0]) == null ? void 0 : _c.content) == null ? void 0 : _d.parts) == null ? void 0 : _e[0]) == null ? void 0 : _f.text) || "";
        ...
        await ingestDocument(doc.id, textToIngest, {
          title,
          category
        });
      } catch (err) {
        ...
        return new Response(JSON.stringify({
          error: `การประมวลผลไฟล์ล้มเหลว: ${err.message}`
        }), {
          status: 400
        });
      }
...
const admin_knowledge = UNSAFE_withComponentProps(function AdminKnowledgePage() {
  ...
  const handleFileSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        const data2 = await res.json().catch(() => ({}));
        throw new Error(data2.error || "เกิดข้อผิดพลาดในการประมวลผลไฟล์");
      }
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("h3", {
            ...
            className: "flex bg-bg-input p-1 rounded-xl gap-1",
            children: [/* @__PURE__ */ jsx("button", {
              type: "button",
              onClick: () => setTab("url"),
              className: `flex-1 text-[11px] font-bold py-2 rounded-lg transition-all ${tab === "url" ? "bg-white text-brand-gold shadow-sm" : "text-text-secondary hover:text-text-primary"}`,
              children: "🔗 เว็บไซต์"
            }), /* @__PURE__ */ jsx("button", {
              type: "button",
              onClick: () => setTab("file"),
              className: `flex-1 text-[11px] font-bold py-2 rounded-lg transition-all ${tab === "file" ? "bg-white text-brand-gold shadow-sm" : "text-text-secondary hover:text-text-primary"}`,
              children: "📁 อัปโหลดไฟล์"
            }), /* @__PURE__ */ jsx("button", {
              type: "button",
              onClick: () => setTab("text"),
              className: `flex-1 text-[11px] font-bold py-2 rounded-lg transition-all ${tab === "text" ? "bg-white text-brand-gold shadow-sm" : "text-text-secondary hover:text-text-primary"}`,
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsx("label", {
                className: "block text-[10px] font-black text-text-muted uppercase tracking-wider mb-1.5 select-none",
                children: "ไฟล์เอกสาร (PDF หรือ TXT)"
              }), /* @__PURE__ */ jsxs("div", {
                className: "border-2 border-dashed border-border-strong hover:border-brand-gold rounded-2xl p-6 text-center cursor-pointer transition-colors relative group",
                children: [/* @__PURE__ */ jsx("input", {
                  type: "file",
                  accept: ".pdf,.txt",
                  onChange: (e) => {
                  ...
                  className: "mx-auto text-text-muted group-hover:text-brand-gold mb-2 transition-colors text-2xl",
                  children: "📁"
                }), /* @__PURE__ */ jsx("p", {
                  className: "text-xs font-black text-text-primary",
                  children: file ? file.name : "เลือกไฟล์ PDF/TXT หรือลากมาวางที่นี่"
                }), /* @__PURE__ */ jsx("p", {
                  className: "text-[10px] text-text-muted mt-1.5 font-bold",
                  children: file ? `${(file.size / (1024 * 1024)).toFixed(2)} MB` : "จำกัดขนาดไฟล์ไม่เกิน 15MB"
                })]
              })]
            }), /* @__PURE__ */ jsx("button", {
              type: "submit",
              ...
              className: "w-full btn-gold justify-center py-3 shadow-sm mt-2 text-xs font-bold",
              children: submitting ? "กำลังสกัดและฝัง Vector..." : "⚡ สกัดข้อมูลไฟล์ & เรียนรู้"
            })]
                  ...
                  children: filteredDocs.length === 0 ? /* @__PURE__ */ jsx("tr", {
                    ...
                    children: [/* @__PURE__ */ jsx("td", {
                      ...
                      children: doc.source_type === "url" ? /* @__PURE__ */ jsx("span", {
                        ...
                        children: "🔗 เว็บไซต์"
                      }) : doc.source_type === "pdf" ? /* @__PURE__ */ jsx("span", {
                        className: "text-[10px] bg-red-50 text-red-700 border border-red-100 rounded px-1.5 py-0.5 font-bold",
                        children: "📁 ไฟล์ PDF"
                      }) : /* @__PURE__ */ jsx("span", {
...
async function verifyUglCredentials(username, password) {
  try {
    ...
    const postRes = await fetch("https://www.uglplatform.com/Account/Login", {
      ...
      redirect: "manual"
      // Stop redirect to inspect response status
    });
    if (postRes.status === 302) {
      ...
      let fullName = "";
      try {
        const targetUrl = redirectLocation.startsWith("http") ? redirectLocation : `https://www.uglplatform.com${redirectLocation}`;
...
async function action$6({
  ...
  try {
    ...
    const {
      ...
      error: profileError
    } = await supabaseAdmin.from("profiles").select("id").eq("username", cleanUsername).maybeSingle();
    if (profileError) {
    ...
    if (existingProfile) {
      ...
      if (referrerId) {
        const {
          error: rpcError
        } = await supabaseAdmin.rpc("increment_referral_conversions", {
    ...
    return new Response(JSON.stringify({
      error: err.message || "เกิดข้อผิดพลาดในการตรวจสอบบัญชี"
    }), {
      status: 500,
      headers: {
        "Content-Type": "application/json"
...
const denMlmCoachSkill = `---
name: น้องยูนิ
description: Unicorn MLM Coach - น้องยูนิ
ทักษะการเป็นโค้ชด้านธุรกิจเครือข่ายและที่ปรึกษาการตลาดดิจิทัลมืออาชีพ (UBC)
---
...
* **น้ำเสียง (Tone of Voice):** สุขุม, มีพลัง, ทันสมัย (Digital Savvy), และเน้นผลลัพธ์ที่เป็นตัวเลขจริง (Data-Driven) ใช้สรรพนามแทนตัวเองว่า "น้องยูนิ" และเรียกผู้ใช้ว่า "คุณพี่" พร้อมลงท้ายด้วย "ค่ะ" หรือ "นะคะ" เสมอ มีพลังบวก (Positive Energy) ✨
...
* **การเริ่มคอนเทนต์:** "ในฐานะที่ปรึกษา (UBC 2) น้องยูนิแนะนำให้คุณพี่เริ่มจากค้นหา Wealth DNA ของคุณพี่ก่อนค่ะ หากคุณพี่คือธาตุไฟ คอนเทนต์ต้องเน้น Vision และความพรีเมียม โดยใช้ Content Pillars 4 แกน และให้ AI ช่วยร่างสคริปต์สั้นๆ เพื่อคุม Brand Voice นะคะ"
* **การจัดการข้อโต้แย้ง:** "ใช้เทคนิค Feel-Felt-Found ค่ะ น้องยูนิเข้าใจความกังวลเรื่องเวลาของคุณพี่ (Feel) เพราะพาร์ทเนอร์หลายคนของน้องยูนิเคยรู้สึกแบบเดียวกัน (Felt) แต่พอได้ใช้ Unicorn Smart AI มาช่วยผ่อนแรง 80% คุณพี่กลับค้นพบว่ามีเวลาเหลือไปดูแลครอบครัวมากขึ้น (Found)..."
