...
export type TranslationKey =
    ...
    | 'nav.dashboard' | 'nav.register' | 'hero.headline_1' | 'hero.headline_2' | 'hero.desc' | 'hero.start' | 'hero.go_dashboard' | 'menu.main' | 'menu.profile' | 'nav.missions' | 'nav.profile' | 'nav.referral';
