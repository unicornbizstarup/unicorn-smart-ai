...
const Functions: React.FC = () => {
  return (
    <div className="space-y-12 animate-fade-in pb-20 px-2 lg:px-0">
          ...
          <div key={group.period} className="glass-card rounded-[3rem] border border-white/40 shadow-sm hover:shadow-2xl transition-all duration-500 group overflow-hidden flex flex-col hover:-translate-y-2">
            ...
            <div className="p-8 flex-1 space-y-6">
              {group.items.map((item) => (
                <div key={item} className="flex items-start gap-4 group/item cursor-pointer">
      ...
      <section className="bg-dark-gradient rounded-[4rem] p-12 lg:p-20 text-white relative overflow-hidden border border-white/10 shadow-3xl group hover-shine">
        ...
        <div className="flex flex-col md:flex-row gap-16 items-center relative z-10">
          <div className="md:w-1/2 space-y-8">
            ...
            <p className="text-indigo-100/70 text-lg font-medium leading-relaxed">
              ...
              กลายเป็นผู้ที่เข้าใจ และพัฒนาไปสู่การเป็นผู้นำ การเคลื่อนคนจากงานเล็กไปสู่งานใหญ่
              คือหัวใจของการขยายธุรกิจอย่างรวดเร็ว <span className="text-amber-400 italic font-black">(Speed of Growth)</span>
            </p>
          ...
          <div className="md:w-1/2 w-full grid grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="group/img relative overflow-hidden rounded-[2.5rem] h-44 shadow-2xl border border-white/5">
                <img
